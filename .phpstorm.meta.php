...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\Booking\BookingClientContract' => \App\Api\Booking\Client::class,
    ...
    override(\config(), map([
            ...
            'services.leadbook.host' => 'string',
            'services.leadbook.token' => 'NULL',
...
'services.slack.notifications.channel','services.leadbook.host','services.leadbook.token','session.driver','session.lifetime',
...
'hashing.rehash_on_login','concurrency.default','view.paths','view.compiled','broadcasting.default',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','horizon.domain',
...
'horizon.jobs.show','horizon.index','sanctum.csrf-cookie','shows.index','shows.events.index',
'events.places.index','events.reserve.store',
'storage.local',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','UID',
'GID',);
